...
export default function Contact() {
  ...
  const socialLinks = [
    { name: "GitHub", url: siteConfig.socials.github, description: "Check out my code", icon: <GitHub className="w-8 h-8" /> },
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-(--muted) max-w-2xl mx-auto">
            Interested in collaborating or just have a question? Feel free to reach out!
          </p>
        </div>
